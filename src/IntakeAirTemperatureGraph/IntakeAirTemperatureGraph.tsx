import { BarElement, CategoryScale, Chart, ChartData, ChartDataset, ChartOptions, Legend, LegendOptions, LinearScale, LineElement, PluginOptionsByType, PointElement, Title, TitleOptions, Tooltip } from "chart.js";
...
export default function IntakeAirTemperatureGraph(intakeAirTemperatureProps: IntakeAirTemperatureProps): ReactElement {
    ...
    intakeAirTemperatureProps.datalogs
    .forEach((datalog) => {
        if (datalog.timestamp !== undefined && datalog.intakeAirTemperature !== undefined) {
